...
<head>
  ...
  <title><?php echo isset($page_title) ? $page_title : 'Changatham - Explore Kerala'; ?></title>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
        <ul class="navbar-nav">
          ...
          <?php if(isset($_SESSION['EMAIL']) && isset($_SESSION['ROLE']) && $_SESSION['ROLE'] !== 'admin' && isset($_SESSION['USER_ID'])): ?>
            <!-- Notifications icon next to Home button for regular users -->
            <?php
            ...
            $unread_count = $unread_count_result ? $unread_count_result->fetch_assoc()['unread_count'] : 0;
            ?>
          ...
          <?php if(isset($_SESSION['EMAIL'])): ?>
            <?php if(isset($_SESSION['ROLE']) && $_SESSION['ROLE'] === 'admin'): ?>
              <!-- Admin Navigation -->
              <li class="nav-item"><a class="nav-link" href="admin_page.php">Admin Dashboard</a></li>
              <li class="nav-item"><a class="nav-link" href="home.php#about">About Us</a></li>
              <li class="nav-item"><a class="nav-link" href="logout.php">Logout (<?php echo isset($_SESSION['USER_NAME']) ? htmlspecialchars($_SESSION['USER_NAME']) : 'Admin'; ?>)</a></li>
            <?php else: ?>
